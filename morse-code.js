...
(function() {
  var ajaxLegacy, alphabet, exercise, genDicts, onReady, ondash, ondot, onletter, onspace, quiz, use,
    __slice = [].slice;
  ...
  */
  ...
  quiz = function(word, cb) {
    var entry, entryLetters, tries;
    uu.log("morsequiz", word);
    tries = 0;
    document.body.innerHTML = jsonml2html.toString(["div", ["h2", word], ["div#hint", ""], ["div#entry", ""], ["div#entryLetters", ""]]);
    tries = 0;
  ...
  uu.onComplete(function() {
    ...
    return genDicts(function(dicts) {
      ...
      nextExercise = function(tries) {
        ...
        return quiz(exercise(lang, i), nextExercise);
      };
